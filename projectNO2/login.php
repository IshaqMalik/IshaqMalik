...
<head>
  ...
  <title>Dr Appointment System </title>
            ...
            <div class="row g-0">
              ...
              <div class="col-md-6 col-lg-7 d-flex align-items-center">
                <div class="card-body p-4 p-lg-5 text-black">
                  <form action="login.php" method="post" class="w-80">
                    ...
                    <a class="small text-muted" href="http://localhost/projectNO2/forgot_password.php">Forgot password?</a>
                    <p class="mb-5 pb-lg-2" style="color: #393f81;">Don't have an account? <a href="http://localhost/projectNO2/signup.php" style="color: #393f81;">Register here</a></p>
                  </form>
                </div>
              </div>
            </div>

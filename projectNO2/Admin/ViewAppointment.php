...
<body class="sb-nav-fixed">
                            ...
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    <table id="datatablesSimple">
                                        ...
                                        if (isset($_GET['id'])) {
                                            $id = $_GET['id'];
                                            $sql = "SELECT bookdoctor.id, bookdoctor.name, bookdoctor.email, bookdoctor.description, bookdoctor.appointingdate
        FROM `doctor`
        INNER JOIN `bookdoctor` ON bookdoctor.doctorId = doctor.id
        WHERE doctor.id = $id";
    ...
    <td><a class='btn btn-danger' href='http://localhost/projectNO2/Delete/del3.php?id=" . $row['id'] . "' onclick='return confirm(\"You want to delete this record?\");'> Delete </a> </td>
    </tr>";
                                            }
                                        }
                                        ?>
